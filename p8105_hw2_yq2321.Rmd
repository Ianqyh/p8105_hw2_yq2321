...
The pols-month dataset has dimension `r nrow(pols_month_data)` x `r ncol(pols_month_data)`. The range of years is from 1947 to 2015. Names of key variables are `r names(pols_month_data)`. 
