...
The number of observations in the resulting Mr.Trash Wheel dataset is `r nrow(trash_wheel_sheet)`. The number of observations in the resulting combined precipitation dataset is `r nrow(precipitation_combined)`. The total precipitation in 2018 is `r sum(pull(precipitation_2018, total))`.
